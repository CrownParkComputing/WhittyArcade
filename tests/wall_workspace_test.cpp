...
void test_compositor_geometry() {
    ...
    int x = -1, y = -1, w = -1, h = -1;
    check(manx_window::compositor_geometry_of(report, 4242, x, y, w, h),
    ...
    check(manx_window::compositor_geometry_of(report, 3233285, x, y, w, h),
    ...
    check(!manx_window::compositor_geometry_of(report, 999, x, y, w, h),
          "an unknown window must report unknown, not stale geometry");
    check(!manx_window::compositor_geometry_of("", 4242, x, y, w, h),
...
int main() {
    ...
    check(manx_window::spare_workspace_from(
    ...
    check(manx_window::spare_workspace_from(report(crowded), 4) == 0,
    ...
    check(manx_window::spare_workspace_from("") == 0,
