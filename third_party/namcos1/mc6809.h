...
#  define LSB 0
   ...
   /* Amiga m68k is BIG-endian: the high byte of a 16-bit register union is at
    * b[0], so MSB=0/LSB=1. (The old MSB=1/LSB=0 byte-swapped every A/B/PC access
    * -> garbage 6809 execution -> garbage video on the Amiga.) */
#  define MSB 0
#  define LSB 1
#else
