...
#define M37710_CALL_DEBUGGER(x)         do { (void)(x); } while (0)
#ifndef CLEAR_LINE
#define CLEAR_LINE                      0
#endif
#ifndef ASSERT_LINE
...
#define STATE_GENPCBASE                 0x1000
#endif
#ifndef logerror
#define logerror(...)                   std::fprintf(stderr, __VA_ARGS__)
#endif
#ifndef debugger_wait_hook
#define debugger_wait_hook()            do { } while (0)
#endif
#define m37710_read_8(addr)             read_byte(addr)
#define m37710_write_8(addr,data)       write_byte(addr,data)
#define m37710_read_8_immediate(A)      read_byte(A)
#define m37710_read_16(addr)            read_word(addr)
#define m37710_write_16(addr,data)      write_word(addr,data)
#define m37710_read_16_immediate(A)     read_word(A)
