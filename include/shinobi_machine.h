...
// on the buffer size. Reference them as shinobi::kSoundProgRomBytes /
...
public:
    ...
    std::array<uint8_t, ::shinobi::kSoundProgRomBytes> sound_prog_rom_{};
    std::array<uint8_t, ::shinobi::kSoundDataRomBytes> sound_data_rom_{};
...
// =====================================================================
// shinobi_machine_t — runtime that drives Shinobi on an m68000_cpu.
//
...
// =====================================================================
class shinobi_machine_t {
public:
    shinobi_machine_t();
    ~shinobi_machine_t();

    shinobi_machine_t(const shinobi_machine_t&) = delete;
    shinobi_machine_t& operator=(const shinobi_machine_t&) = delete;
