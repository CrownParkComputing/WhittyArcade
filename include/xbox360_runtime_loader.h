...
public:
    ...
    bool initialize(const std::string& game_root,
                    ...
                    std::string& error);
    void shutdown();
    void set_input(const manx_xbox360_input& input);
    bool vibration(manx_xbox360_vibration& output) const;
...
private:
    ...
    void* m_library{};
    const manx_xbox360_api* m_api{};
    manx_xbox360_runtime* m_runtime{};
    void* m_worker_state{};
    int m_worker_fd{-1};
