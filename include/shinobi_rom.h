...
//
// On success result.set is shinobi_rom_set::shinobi_us, result.roms is
...
enum class shinobi_rom_set : uint8_t {
    unknown,
    shinobi_us,
};
...
struct shinobi_rom_load_result {
    shinobi_rom_set set{shinobi_rom_set::unknown};
    shinobi_roms   roms{};
    std::string    error{};
...
class shinobi_rom_loader {
public:
    static shinobi_rom_set identify_set(const std::string& path);
    static const char*      set_short_name(shinobi_rom_set set);
    static const char*      set_display_name(shinobi_rom_set set);
    static shinobi_rom_load_result load(const std::string& path);
};
