...
class system16b_sound_synth {
public:
    static constexpr int sample_rate = 48'000;
    static constexpr int chip_clock_hz = 4'000'000;

    system16b_sound_synth();
    ~system16b_sound_synth();

    system16b_sound_synth(const system16b_sound_synth&) = delete;
    system16b_sound_synth& operator=(const system16b_sound_synth&) = delete;
...
public:
    ...
    explicit system16b_audio_system(std::unique_ptr<system16b_sound_synth> synth);
    ~system16b_audio_system();

    system16b_audio_system(const system16b_audio_system&) = delete;
    system16b_audio_system& operator=(const system16b_audio_system&) = delete;
...
private:
    ...
    std::unique_ptr<system16b_sound_synth> m_synth;
